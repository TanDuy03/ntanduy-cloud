                ...
                <div class="grid grid-cols-1 md:items-stretch md:grid-cols-2 gap-x-12 lg:gap-x-20 gap-y-10">
                    <div class="flex flex-col lg:py-5">
                        ...
                        <div class="mt-10">
                            ...
                            <blockquote class="mt-3 slide-down2">
                                <p class="text-sm leading-relaxed text-white">You made it so simple. My new site is so
                                    much faster
                                    and easier to work with than my old site. I just choose the page, make the change
                                    and click save.
                                </p>
                            </blockquote>
                            ...
                            <div class="flex items-center mt-8 slide-down3">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="mt-px text-sm text-gray-400">{{ description }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="slide-right">
                        <div class="overflow-hidden bg-white rounded-md" style="z-index: -1;">
                            <div class="p-10">
                                <h3 class="text-xs font-semibold tracking-widest text-purple-600 uppercase">Single pack
                                </h3>
                                <p class="mt-4 text-6xl font-bold text-black">$79</p>

                                <ul class="flex flex-col mt-8 space-y-4">
                                    <li class="inline-flex items-center space-x-2">
                                        <svg class="flex-shrink-0 w-5 h-5 text-green-500 icon-social"
                                    ...
                                    <li class="inline-flex items-center space-x-2">
                                        ...
                                        <span class="text-base font-medium text-gray-900"> Full Celebration Library
                                        </span>
                                    </li>
                                ...
                                <div class="flex items-center mt-5">
                                    <svg class="flex-shrink-0 w-5 h-5 text-gray-500 icon-social"
