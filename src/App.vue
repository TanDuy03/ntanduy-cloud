    ...
    setup() {
      ...
      useHead({
        ...
        link: computed(() => [
          ...
          { rel: 'preload', as: 'image', href: "https://ik.imagekit.io/odbmay3h6/banner.webp?updatedAt=1724402641525" },
          { rel: 'preconnect', href: "https://fonts.googleapis.com" },
          { rel: 'preconnect', href: "https://fonts.gstatic.com" },
          { rel: 'preload', as: 'style', href: 'https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap', crossorigin: 'anonymous' },
          { rel: 'stylesheet', href: 'https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap', crossorigin: 'anonymous' },
          { rel: 'preload', as: 'style', href: 'https://unpkg.com/boxicons@2.1.4/css/boxicons.min.css' },
